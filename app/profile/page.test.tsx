...
describe('ProfilePage', () => {
    ...
    it('should display error if fetching profile data fails', async () => {
        ...
        await waitFor(() =>
            expect(
                screen.getByText('Error fetching profile data'),
            ).toBeInTheDocument(),
        );
    });
    ...
    it('should display employee data and departments', async () => {
        ...
        (getUserDepartmentsNew as jest.Mock).mockResolvedValue([
            'HR',
            'Engineering',
        ]);
        ...
        expect(
            screen.getByText('Employee at Datum since 2023-01-01'),
        ).toBeInTheDocument();
    ...
    it('should send verification code for updating phone number', async () => {
        ...
        (sendVerificationCode as jest.Mock).mockResolvedValue(
    ...
    it('should verify and update phone number', async () => {
        ...
        await waitFor(() =>
            expect(verifyAndUpdatePhoneNumber).toHaveBeenCalledWith(
                '123456',
                'test-verification-id',
            ),
        );
