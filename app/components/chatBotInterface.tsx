...
export default function Component() {
  ...
  const handleSummarize = () => {
    ...
    setSummary('This is a simulated summary of the uploaded file. In a real application, this would be the result of processing the file content.')
  }
      ...
      >
        <div className="flex flex-col h-[600px]">
          ...
          <Tabs defaultValue="chat" className="flex flex-col h-full">
            ...
            <TabsContent value="summarize" className="flex flex-col flex-1 h-full">
              <div className="flex-1 p-4 flex flex-col">
                <div className="text-2xl font-medium text-center mb-4">Summary</div>
                <div className="flex-1 bg-muted/50 rounded-lg p-4 overflow-y-auto h-[400px]">
                  {summary ? (
                    <p className="text-muted-foreground">{summary}</p>
                  ) : (
                    <p className="text-muted-foreground text-center">
                      {selectedFile ? 'Click Summarize to process the file' : 'Select a file to see its summary'}
                    </p>
                  )}
                </div>
              </div>
            ...
            <TabsContent value="chat" className="flex flex-col h-full">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div ref={messagesEndRef} /> {/* Ensure this is at the bottom of the messages */}
              </div>
