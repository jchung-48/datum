...
describe('handleFileDelete', () => {
    ...
    it('throws an error for an invalid Firestore path', async () => {
        ...
        await expect(
            handleFileDelete(fileFullPath, invalidPath),
    ...
    it('handles errors during file deletion from Firebase Storage', async () => {
        ...
        await expect(
            handleFileDelete(fileFullPath, firestorePath),
        ).rejects.toThrow('Storage deletion error');
    ...
    it('handles errors during Firestore document deletion', async () => {
        ...
        (deleteDoc as jest.Mock).mockRejectedValue(
            new Error('Firestore deletion error'),
        );

        await expect(
            handleFileDelete(fileFullPath, firestorePath),
        ).rejects.toThrow('Firestore deletion error');
