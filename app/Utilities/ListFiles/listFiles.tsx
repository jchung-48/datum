    ...
    for (let i = 1; i < sortedFiles.length; i++) {
      ...
      while (index >= 0) {
        ...
        if (field === 'uploadTimeStamp') {
          comparison =
            sortedFiles[index][field].toDate() > file[field].toDate() ? 1 : -1;
          ...
          if (
            ...
            comparison = sortedFiles[index].userDisplayName.localeCompare(
            ...
            <tr>
              ...
              <th>
                <a
                  className="sortable-header"
                  onClick={() =>
                    handleSortFieldClick('owner', 'userDisplayName')
                  }
                >
                  Owner{' '}
                  <img
              ...
              <th>
                <a
                  className="sortable-header"
                  onClick={() =>
                    handleSortFieldClick('time', 'uploadTimeStamp')
                  }
                >
                  Upload Date{' '}
                  <img
