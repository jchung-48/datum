...
import { signInUser, getUserDepartments, resetPassword } from '@/app/authentication';
...
describe('SignIn Page', () => {
  ...
  it('should alert user to enter an email for password reset', () => {
    ...
    expect(global.alert).toHaveBeenCalledWith('Please enter an email in order to reset your password!');
  });
});
