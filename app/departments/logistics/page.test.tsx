...
describe("LogisticsDepartment Component", () => {
  ...
  it("handles collection selection change", () => {
    ...
    expect(collectionSelect.value).toBe("customsFiles");
  });
  ...
  it("triggers AIButton functionality", () => {
    ...
    (AIButton as jest.Mock).mockImplementation(() => <button data-testid="ai-button" onClick={mockAIButtonHandler}>AI Button</button>);
